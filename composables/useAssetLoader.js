 ...
 * images, pulled straight from the Prismic document) and download them with
 * real byte-level progress, so the four logo bars only reach 100% once the
 * site's media is genuinely buffered and ready to use.
 *
